            ...
            <div className="flex h-full bg-white overflow-hidden rounded-t-[32px] border-t border-slate-100 shadow-2xl shadow-indigo-500/10">
                    ...
                    <div className="flex-1 overflow-y-auto px-3 space-y-1 custom-scrollbar">
                        ...
                        {sortedProjects.map(project => (
                            <button
                                ...
                                className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-xl transition-all duration-200 group relative ${selectedProjectId === project.id
                                    ? 'bg-white shadow-md shadow-indigo-500/5 text-indigo-600 border border-slate-100'
                ...
                <div className="flex-1 flex flex-col min-w-0 bg-white">
                    {selectedProject ? (
                        <>
                            {/* Chat Header */}
                            <div className="h-14 border-b border-slate-50 px-4 flex items-center justify-between shrink-0 bg-white/80 backdrop-blur-md sticky top-0 z-10">
                            ...
                            <div className="flex-1 flex min-w-0 overflow-hidden">
                                <div className="flex-1 flex flex-col min-w-0 bg-white relative">
                                    ...
                                    <div
                                        ...
                                        className="flex-1 overflow-y-auto custom-scrollbar bg-white px-4 py-4 md:px-6 relative"
                                    >
                                                            ...
                                                            <React.Fragment key={msg.id}>
                                                                ...
                                                                <div id={`msg-${msg.id}`} className={`group relative flex items-start gap-4 ${isMine ? 'flex-row-reverse' : ''} ${!showAvatar ? 'mt-[-28px]' : ''}`}>
                                                                    ...
                                                                    <div className="shrink-0 pt-1 relative">
                                                                        {showAvatar ? (
                                                                            <>
                                                                                <Avatar className="w-8 h-8 rounded-xl shadow-lg shadow-indigo-500/10 ring-2 ring-white border border-slate-100">
                                                                                    <AvatarImage src={msg.authorAvatar} />
                                                                                    <AvatarFallback className="bg-slate-800 text-white font-black text-[9px]">{msg.authorName.substring(0, 2).toUpperCase()}</AvatarFallback>
                                                                                </Avatar>
                                                                                {onlineUsers.includes(msg.authorId) && (
                                                                                    <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-emerald-500 border-2 border-white rounded-full transition-all duration-500 animate-pulse shadow-sm" />
                                                                                )}
                                                                            </>
                                                                        ) : (
                                    ...
                                    {/* Chat Input */}
                                    <div className="p-2 md:px-4 bg-white border-t border-slate-100 shrink-0 shadow-[0_-10px_40px_rgba(0,0,0,0.02)] z-10">
                                        <div className="max-w-5xl mx-auto">
                                            ...
                                            <div className="bg-slate-50 border border-slate-100 rounded-[32px] overflow-hidden p-2 flex flex-col gap-2 transition-all focus-within:bg-white focus-within:shadow-2xl focus-within:shadow-indigo-500/10 focus-within:border-indigo-100 ring-1 ring-black/[0.01]">
                                                ...
                                                {(replyTo || editingMessage) && (
                                                    <div className="bg-indigo-50/5 border-b border-indigo-100/50 px-3 py-1.5 flex items-center justify-between animate-in slide-in-from-bottom-2">
                                                ...
                                                <div className="flex items-center justify-between px-2 pb-1 pt-1 border-t border-slate-50 mt-1 gap-1">
                                                    <div className="flex-1 min-w-0 flex items-center gap-0.5 overflow-x-auto custom-scrollbar pb-0.5">
                                            ...
                                            {/* Shortcut hints removed to save vertical space */}
                                        </div>
                                    </div>
                                </div>
