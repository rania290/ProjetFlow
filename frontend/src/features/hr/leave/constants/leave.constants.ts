...
export const LEAVE_TYPE_COLORS: Record<LeaveType, string> = {
  ...
  MATERNITY: 'bg-amber-50 text-amber-800 border border-amber-200 shadow-sm',
...
export const STATUS_CONFIG: Record<LeaveStatus, { label: string; badgeClass: string; dotClass: string }> = {
  ...
  CHEF_APPROVED: {
    label: 'Validé par Chef',
    badgeClass: 'bg-blue-50 text-blue-700 border border-blue-200 shadow-sm',
